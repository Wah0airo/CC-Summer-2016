...
int SYM_NEGATION     = 34; // !
int SYM_LOGICAL_AND  = 35; // &&
int SYM_LOGICAL_OR   = 36; // ||
...
// |  8 | size    | Array size
// |  9 | cols    | Array columns (only 2D array)
// | 10 | struct  | pointer -> struct
// +----+---------+

struct SymbolTableEntry* getNextEntry(struct SymbolTableEntry* entry)  {
    return entry->next;
}
int* getString(struct SymbolTableEntry* entry) {
    return (int*) entry->string;
}
int  getLineNumber(struct SymbolTableEntry* entry) {
    return entry->line;
}
int  getClass(struct SymbolTableEntry* entry) {
    return entry->class;
}
int  getType(struct SymbolTableEntry* entry) {
    return entry->type;
}
int  getValue(struct SymbolTableEntry* entry) {
    return entry->value;
}
int  getAddress(struct SymbolTableEntry* entry) {
    return entry->address;
}
int  getScope(struct SymbolTableEntry* entry) {
    return entry->scope;
}
int  getSize(struct SymbolTableEntry* entry) {
    return entry->size;
}

int  getColumns(struct SymbolTableEntry* entry) {
    return entry->columns;
}
int* getStruct(struct SymbolTableEntry* entry) {
    return (int*) entry->entry;
}

void setNextEntry(struct SymbolTableEntry* entry, struct SymbolTableEntry* next) {
    entry->next = next;
}
void setString(struct SymbolTableEntry* entry, int* string) {
    entry->string = (int) string;
}
void setLineNumber(struct SymbolTableEntry* entry, int line) {
    entry->line = line;
}
void setClass(struct SymbolTableEntry* entry, int class) {
    entry->class = class;
}
void setType(struct SymbolTableEntry* entry, int type) {
    entry->type = type;
}
void setValue(struct SymbolTableEntry* entry, int value) {
    entry->value = value;
}
void setAddress(struct SymbolTableEntry* entry, int address) {
    entry->address = address;
}
void setScope(struct SymbolTableEntry* entry, int scope) {
    entry->scope = scope;
}
void setSize(struct SymbolTableEntry* entry, int size) {
    entry->size = size;
}

void setColumns(struct SymbolTableEntry* entry, int cols) {
    entry->columns = cols;
}
void setStruct(struct SymbolTableEntry* entry, int* structEntry) {
    entry->entry = structEntry;
}
...
// |  4 | number_of_fields | # of fields
// |  5 | fields           | pointer to the first field
// |  6 | size             | size
// +----+------------------+

int* getNextStructEntry(int* entry)  {
    return (int*) *entry;
}
int* getStructName(int* entry)       {
    return (int*) *(entry + 1);
}
int  getStructLineNumber(int* entry) {
    return *(entry + 2);
}
int  getStructScope(int* entry)      {
    return *(entry + 3);
}
int  getNumber_of_fields(int* entry) {
    return *(entry + 4);
}
int* getStructFields(int* entry)     {
    return (int*) *(entry + 5);
}
int  getStructSize(int* entry)       {
    return *(entry + 6);
}

void setNextStructEntry(int* entry, int* next)    {
    *entry       = (int) next;
}
void setStructName(int* entry, int* name)         {
    *(entry + 1) = (int) name;
}
void setStructLineNumber(int* entry, int line)    {
    *(entry + 2) = line;
}
void setStructScope(int* entry, int scope)        {
    *(entry + 3) = scope;
}
void setNumber_of_fields(int* entry, int number_of_fields)    {
    *(entry + 4) = number_of_fields;
}
void setStructFields(int* entry, int* fields)     {
    *(entry + 5) = (int) fields;
}
...
// table pointers
struct SymbolTableEntry* global_symbol_table  = (struct SymbolTableEntry*) 0;
struct SymbolTableEntry* local_symbol_table   = (struct SymbolTableEntry*) 0;
struct SymbolTableEntry* library_symbol_table = (struct SymbolTableEntry*) 0;
...
void gr_statement();
int  gr_type();
void gr_variable(int offset, int* new_struct, int isField, int* addressCounter);
void gr_initialization(int* name, int offset, int type, int is_struct);
...
int  gr_struct(int whichTable, int offset, int* addressCounter);
...
void syntaxErrorCharacter(int expected) {
    printLineNumber((int*) "syntaxErrorCharacter ", lineNumber);
...
int getSymbol() {
    ...
    else if (character == CHAR_VERTICAL_BAR){
        getCharacter();
        
        if (character == CHAR_VERTICAL_BAR){
            getCharacter();
...
void createSymbolTableEntry(int whichTable, int* string, int line, int class, int type, int value, int address, int size, int cols, int* newStruct) {
    ...
    // LOCAL_TABLE   = 2;
    // LIBRARY_TABLE = 3;
    //print((int*)"CreateSymbolTableEntry ");
    //print(itoa(whichTable, string_buffer, 10, 0, 0));
    newEntry = (struct SymbolTableEntry*) malloc(3 * SIZEOFINTSTAR + 9 * SIZEOFINT);
    //print((int*)" string: ");
    newEntry->string = (int) string;
    //printString(newEntry->string);
    //print((int*)" line ");
    newEntry->line = line;
    //print(itoa(newEntry->line, string_buffer, 10, 0, 0));
    //print((int*)" class ");
    newEntry->class = class;
    //print(itoa(newEntry->class, string_buffer, 10, 0, 0));
    //print((int*)" value ");
    newEntry->type = type;
    newEntry->value = value;
    //print(itoa(newEntry->value, string_buffer, 10, 0, 0));
    //print((int*)" address ");
    //setAddress(newEntry, address);
    newEntry->address = address;
    //print(itoa(newEntry->address, string_buffer, 10, 0, 0));
    //print((int*)" size ");
    newEntry->size = size;
    //print(itoa(newEntry->size, string_buffer, 10, 0, 0));
    //print((int*)" cols ");
    newEntry->columns = cols;
    //print(itoa(newEntry->columns, string_buffer, 10, 0, 0));
    //print((int*)" newStruct ");
    newEntry->entry = newStruct;
    
    //if(whichTable == 3) {
        //print((int*)" STE Library name: ");
        //printString(newEntry->string);
        //print((int*)" line ");
        //print(itoa(newEntry->line, string_buffer, 10, 0, 0));
        //print((int*)" class ");
    ...
    //if(stringCompare(string, (int*)"malloc")) {
      //  print((int*)" Malloc ");
      //  printString(newEntry->string);
      //  print((int*)" line ");
      //  print(itoa(newEntry->line, string_buffer, 10, 0, 0));
    ...
    //print((int*)" scope: ");
    //print(itoa(newEntry->scope, string_buffer, 10, 0, 0));
...
void createStructTableEntry(int whichTable, int* name, int line) {
    ...
    setNumber_of_fields(newEntry, 0);
...
int isUndefinedProcedure(struct SymbolTableEntry* entry) {
    ...
    if (getClass(entry) == PROCEDURE) {
        ...
        if (getAddress(entry) == 0)
            ...
            print((int*)"IUP, JAL, entry->address:");
            print(itoa(entry->address, string_buffer, 10, 0, 0));
            print((int*)" name:");
...
void syntaxErrorSymbol(int expected) {
    printLineNumber((int*) "syntaxErrorSymbol", lineNumber);
...
void typeWarning(int expected, int found) {
    printLineNumber((int*) "typeWarning", lineNumber);
...
int load_variable(int* variable) {
    ...
    // assert: if array: only use when array is a call parameter
...
void load_string(int* string) {
    ...
    createSymbolTableEntry(GLOBAL_TABLE, string, lineNumber, STRING, INTSTAR_T, 0, -allocatedMemory, 0, 0, (int*) 0);
...
int help_call_codegen(struct SymbolTableEntry* entry, int* procedure) {
    ...
    if (entry == (struct SymbolTableEntry*) 0) {
        ...
        createSymbolTableEntry(GLOBAL_TABLE, procedure, lineNumber, PROCEDURE, INT_T, 0, binaryLength, 0, 0, (int*) 0);
        print((int*)"H_C_C, JAL, Case1");
        printLineNumber((int*)"ln: ", lineNumber);
        println();
        ...
        if (getAddress(entry) == 0) {
            ...
            //print((int*)"H_C_C, JAL, Case2:");
            //print(itoa(entry->address, string_buffer, 10, 0, 0));
            //print((int*)" name:");
            //printString(entry->string);
            //print((int*)" scope:");
            //print(itoa(entry->scope, string_buffer, 10, 0, 0));
            //print((int*)" type:");
            ...
            //print((int*)"H_C_C, JAL, function Call address/W:");
            //print(itoa(entry->address / WORDSIZE, string_buffer, 10, 0, 0));
            //print((int*)" GA/WS:");
            //print(itoa(getAddress(entry) / WORDSIZE, string_buffer, 10, 0, 0));
            //print((int*)" name:");
            //printString(entry->string);
            //printLineNumber((int*)"ln: ", lineNumber);
            //println();
            ...
            //print((int*)"H_C_C, JAL, function defined address/W:");
            //print(itoa(entry->address/WORDSIZE, string_buffer, 10, 0, 0));
            //print((int*)" name:");
            //printString(entry->string);
            //printLineNumber((int*)"ln: ", lineNumber);
                ...
                if(symbol == SYM_SEMICOLON) {
                    ...
                    if(symbol == SYM_INTEGER) {
                        if(literal > 0) {
                            ...
                            syntaxErrorMessage((int*) "index 2D should be > 0");
                        }
                    }
                    else {
                        syntaxErrorMessage((int*) "2 D lenght must be an integer number");
                    }
                }
                //2D
                else {
                    syntaxErrorMessage((int*) "; or [ expected");
                }
            }
            else {
                syntaxErrorMessage((int*) "] expected");
...
int gr_factor(int* constFold) {
    ...
    if (symbol == SYM_LPARENTHESIS) {
        ...
        // cast: "(" "int" [ "*" ] ")"
        if (symbol == SYM_STRUCT || symbol == SYM_INT) {
            hasCast = 1;
    ...
    if (symbol == SYM_ASTERISK) {
        ...
        //Array zugriff variable = array[];
            ...
            type = gr_expression();
            //print((int*) " after expr symbol:");
            //printSymbol(symbol);
            
            if (type != INT_T) {
                print((int*) "TW, gr_factor INT ");
            ...
            if (symbol == SYM_RBRACKET) {
                getSymbol();
                //print((int*) " after ] symbol:");
                //printSymbol(symbol);
                
                if(symbol==SYM_LBRACKET) {
                    getSymbol();
                    //  print((int*) "factor [ cols:"); //Zugriff
                    // print(itoa(getCols(entry), string_buffer, 10, 0, 0));
                    // printLineNumber((int*) " ln ", lineNumber);
                    // println();
                    load_integer(getColumns(entry));
        ...
        //TODO Struct access (factor)
            ...
            if(symbol == SYM_IDENTIFIER) {
                ...
                talloc();
                emitIFormat(OP_LW, getScope(entry), currentTemporary(), getAddress(entry));
                emitIFormat(OP_LW, currentTemporary(), currentTemporary(), getAddress(field));
            }
            else {
...
int gr_term(int* constFold) {
    ...
    while (isStarOrDivOrModulo()) {
        ...
        if (ltype != rtype) {
            print((int*) "TW, gr_term ");
            typeWarning(ltype, rtype);
        }
        if(ill) {
            if(irl) {
                if (operatorSymbol == SYM_ASTERISK)
                    *constFold = leftValue * *(constFold);
                ...
                isLiteralNumber = 1;
                // print((int*)"in term constant Folding: ");
...
int gr_comparison() {
    ...
    *(constFold) = 0;
    ...
    if (isComparison()) {
        ...
        getSymbol();
        isLiteralNumber = 0;
        rtype = gr_shiftExpression(constFold);
...
void gr_return(int returnType) {
    ...
    if (symbol != SYM_SEMICOLON) {
        ...
        if (returnType == VOID_T) {
            print((int*) "TW, gr_return void ");
            typeWarning(type, returnType);
        }
        else if (type != returnType) {
            print((int*) "TW, gr_return return ");
...
void gr_statement() {
    ...
    int* variableOrProcedureName;
    struct SymbolTableEntry* entry;
    struct SymbolTableEntry* entryFieldList;
    //struct SymbolTableEntry* struct_entry;
    int memsize;
    int fieldAddress;
    int* pointerToStruct;
    ...
    if (symbol == SYM_ASTERISK) {
        ...
        if (symbol == SYM_IDENTIFIER) {
            ...
            if (symbol == SYM_SEMICOLON)
                ...
                syntaxErrorMessage((int*) "gr_Statement_1, ;error");
                println();
            ...
            if (symbol == SYM_RPARENTHESIS) {
                ...
                if (symbol == SYM_ASSIGN) {
                    ...
                    if (rtype != INT_T) {
                        print((int*) "TW, gr_statement INT_II ");
                        typeWarning(INT_T, rtype);
                    }
                ...
                if (symbol == SYM_SEMICOLON)
                    ...
                    syntaxErrorMessage((int*) "gr_Statement_2, ;error");
                    println();
                    syntaxErrorSymbol(SYM_SEMICOLON);
                }
            } else
    ...
    //TODO array
        ...
        if (symbol == SYM_LPARENTHESIS) {
            ...
            if (symbol == SYM_SEMICOLON)
                ...
                syntaxErrorMessage((int*) "gr_Statement_3, ;error");
                println();
                syntaxErrorSymbol(SYM_SEMICOLON);
            }
        ...
        //ZUweisung 2D array
            ...
            rtype = gr_expression();
            if (rtype != INT_T) {
                print((int*) "TW, gr_statement INT_III ");
                typeWarning(INT_T, ltype);
            }
            if(symbol == SYM_RBRACKET) {
                getSymbol();
                if(symbol == SYM_LBRACKET) {
                    ...
                    if (rtype != INT_T) {
                        print((int*) "TW, gr_statement INT_IV ");
                        typeWarning(INT_T, rtype);
                    }
            ...
            if (symbol == SYM_ASSIGN) {
                ...
                if (rtype != ltype) {
                    print((int*) "TW, gr_statement ASSI ");
                    print(itoa(ltype, string_buffer, 10, 0, 0));
                    print((int*) " rtype=");
                    print(itoa(rtype, string_buffer, 10, 0, 0));
                    typeWarning(ltype, rtype);
                }
            ...
            getSymbol();
            rtype = gr_expression();
            if(rtype != ltype && ltype != STRUCT_T) {
                print((int*) "TW, gr_statement STRUCT ltype=");
                print(itoa(ltype, string_buffer, 10, 0, 0));
                print((int*) " rtype=");
                print(itoa(rtype, string_buffer, 10, 0, 0));
                print((int*) " varN=");
        ...
        //*********************************
            ...
            getSymbol();
            if(symbol == SYM_IDENTIFIER) {
                entryFieldList = getVariable(identifier);
                ltype = STRUCT_T;
                //print((int*) "Statement ->field ");
                //printString(entryFieldList->string);
                //print((int*) " identifier: ");
                //printString(identifier);
                //print((int*) " address: ");
                //print(itoa(entryFieldList->address, string_buffer, 10, 0, 0));
                //printLineNumber((int*) "ln:", lineNumber);
                //println();
                ...
                if(symbol == SYM_ASSIGN) {
                    ...
                    //TODO ERROR??
                    emitIFormat(OP_LW, getScope(entry), currentTemporary(), getAddress(entry));
                    emitIFormat(OP_SW, currentTemporary(), previousTemporary(), getAddress(entryFieldList));
                    tfree(2);
                    if (symbol == SYM_SEMICOLON)
                        getSymbol();
                    else
    ...
    if (symbol == SYM_IDENTIFIER) {
        ...
        if (symbol==SYM_ASTERISK) {
            ...
            if(symbol ==SYM_IDENTIFIER) {
                ...
                //      println();
                if(symbol == SYM_LPARENTHESIS) {
                    //print((int*) "gr_struct ( vor procedure ");
                    gr_procedure(identifier, STRUCT_T);
                    //printSymbol(symbol);
                    //println();
                }
                else {
                    ...
                    if (whichTable == GLOBAL_TABLE) {
                        ...
                        offset_copy = -allocatedMemory;
                    }
                    //print((int*)"gr_struct, cSTE ");
                    //print((int*)"  ident:");
                    //printString(identifier);
                    //print((int*)"  ln:");
                    //print(itoa(lineNumber, string_buffer, 10, 0, 0));
                    //print((int*)"  offset:");
                    //print(itoa(offset_copy, string_buffer, 10, 0, 0));
                    //print((int*)"  whichTable:");
                    //print(itoa(whichTable, string_buffer, 10, 0, 0));
                    //println();
                    createSymbolTableEntry(whichTable, identifier, lineNumber, STRUCT, type, 0, offset_copy, 0, 0, entry);
                    //return type;
                    if(whichTable == GLOBAL_TABLE && symbol == SYM_ASSIGN) {
                        //allocatedmemory = allocatedMemory + WORDSIZE;
                        //print((int*)"gr_struct, vor initialization ");
                        //printSymbol(symbol);
                        //print((int*)"  ");
                        //printString(variableOrProcedureName);
                        //print((int*)"  ident:");
                        //printString(ident);
                        //println();
                        gr_initialization(ident, offset_copy, STRUCT_T, 1);
                        //printSymbol(symbol);
                        //printLineNumber((int*) "ln:", lineNumber);
                        //println();
                    }
        ...
        //definition
            ...
            while(isStruct()) {
                ...
                if(whichTable == GLOBAL_TABLE) {
                    gr_variable(0, global_struct_table, 1, addressCounter);
                    global_symbol_table->address = getStructSize(global_struct_table);
                    //Works only if all sizes are 4, must be corrected
                    global_symbol_table->size = 4;
                    setStructSize(global_struct_table, getStructSize(global_struct_table) + getSize(global_symbol_table));
                    ...
                    //print((int*)" GST size:");
                    //print(itoa(getStructSize(global_struct_table), string_buffer, 10, 0, 0));
                    //print((int*)" GlobalST size:");
                    //print(itoa(getSize(global_symbol_table), string_buffer, 10, 0, 0));
                    //print((int*)" GSymbolT address:");
                    //print(itoa(global_symbol_table->address , string_buffer, 10, 0, 0));
                    //printLineNumber((int*)"ln: ", lineNumber);
                    //println();
                    
                }
                else if(whichTable == LOCAL_TABLE) {
                    gr_variable(0, local_struct_table, 1, addressCounter);
                    local_symbol_table->address = getStructSize(local_struct_table);
                    local_symbol_table->size = 4;
                    setStructSize(local_struct_table, getStructSize(local_struct_table) + getSize(local_symbol_table));
                }
            ...
            if(whichTable == GLOBAL_TABLE) {
                //print((int*)" GLOBAL #fields:");
                //print(itoa(number_of_fields, string_buffer, 10, 0, 0));
                //println();
                setNumber_of_fields(global_struct_table, number_of_fields);
            }
            else
                setNumber_of_fields(local_struct_table, number_of_fields);
...
void gr_variable(int offset, int* new_struct, int isField, int* addressCounter) {
    ...
    if (symbol == SYM_IDENTIFIER) {
        ...
        getSymbol();
        if(symbol == SYM_LBRACKET) {
            //print((int*)" gr_variable vor declare_array ");
            //printSymbol(symbol);
            //println();
            getSymbol();
            ...
            if(type == STRUCT_T) {
                if(new_struct == (int*) 0) {
                    createSymbolTableEntry(LOCAL_TABLE, ident, lineNumber, STRUCT, type, 0, offset, 0, 0, (int*) 0);
                    //TODO check
                    //setStruct(local_symbol_table, getStructTableEntry(getAttributeString(attribute)));
                }
            }
            else if(new_struct == (int*) 0) {
                if(isField == 0) {
            ...
            if(isField==1) {
                if (getStructScope(new_struct) == REG_GP) {
                    //print((int*)"CREATE STRUCT FIELD ");
                    //printString(identifier);
                    //print((int*)" ");
                    //printString(ident);
                    //print((int*)" type=");
                    //print(itoa(type, string_buffer, 10, 0, 0));
                    //println();
                    createSymbolTableEntry(GLOBAL_TABLE, identifier, lineNumber, FIELD, type, 0, offset, 0, 0, new_struct);
                }
                else {
                    createSymbolTableEntry(LOCAL_TABLE, identifier, lineNumber, FIELD, type, 0, offset, 0, 0, new_struct );
                }
            }
        ...
        createSymbolTableEntry(LOCAL_TABLE, (int*) "missing variable name", lineNumber, VARIABLE, type, 0, offset, 0, 0, (int*) 0);
    }
}
...
void gr_initialization(int* name, int offset, int type, int is_struct) {
    ...
    if (symbol == SYM_ASSIGN) {
        ...
        if (is_struct == 0) {
            if(symbol == SYM_SEMICOLON)
                ...
                syntaxErrorMessage((int*) "gr_initialization, ;error ");
                printSymbol(symbol);
                println();
                syntaxErrorSymbol(SYM_SEMICOLON);
            }
    ...
    if (hasCast) {
        if (type != cast) {
            print((int*) "TW, gr_ini cast ");
            typeWarning(type, cast);
        }
    }
    else if (type != INT_T) {
        print((int*) "TW, gr_ini INT ");
        typeWarning(type, INT_T);
    }
    //DONE
    if (is_struct) {
        //print((int*) "gr_initialization, is_struct ");
        //printString(name);
        //println();
        entry = getSymbolTableEntry(name, STRUCT);
        //print((int*)"GR_INI, AFTER SEARCH.... ");
        if(entry != (struct SymbolTableEntry*) 0) {
        ...
        createSymbolTableEntry(GLOBAL_TABLE, name, actualLineNumber, VARIABLE, type, initialValue, offset, 0, 0, (int*) 0);
}
...
void gr_procedure(int* procedure, int returnType) {
    ...
    if (symbol == SYM_LPARENTHESIS) {
        ...
        *(add_counter) = 0;
        if (symbol != SYM_RPARENTHESIS) {
            gr_variable(0, (int*) 0, 0, add_counter);
            
            //print((int*) "gr_procedure, PARAMETER, symbol: ");
            //printSymbol(symbol);
    ...
    if (symbol == SYM_SEMICOLON) {
        ...
        if (entry == (struct SymbolTableEntry*) 0) {
           // print((int*) "GRPROC, STE==0, name: ");
           // printString(currentProcedureName);
           // print((int*) " type ");
           // print(itoa(returnType, string_buffer, 10, 0, 0));
            //print((int*) " string ");
            //printString(entry->string);
           // println();
            createSymbolTableEntry(GLOBAL_TABLE, currentProcedureName, lineNumber, PROCEDURE, returnType, 0, 0, 0, 0, (int*) 0);
        }
        ...
        if (entry == (struct SymbolTableEntry*) 0) {
            //print((int*) "GRPROC, createProcedure, name: ");
            //printString(currentProcedureName);
            //print((int*) " type ");
            //print(itoa(returnType, string_buffer, 10, 0, 0));
            //println();
            createSymbolTableEntry(GLOBAL_TABLE, currentProcedureName, lineNumber, PROCEDURE, returnType, 0, binaryLength, 0, 0, (int*) 0);
        }
        else {
            if (getAddress(entry) != 0) {
                if (getOpcode(loadBinary(getAddress(entry))) == OP_JAL) {
                    //print((int*)"gr_procedure, JAL, address:");
                    //print(itoa(entry->address, string_buffer, 10, 0, 0));
                    //print((int*)" name:");
                    //printString(entry->string);
                    //printLineNumber((int*)"ln: ", lineNumber);
            ...
            if (getType(entry) != returnType) {
                print((int*) "TW, gr_proc, returnType entry->type:");
                print(itoa(entry->type, string_buffer, 10, 0, 0));
                print((int*) " returnType:");
                print(itoa(returnType, string_buffer, 10, 0, 0));
                print((int*) " name:");
                printString(getString(entry));
                println();
        ...
        *(add_counter) = 0;
        while (symbol == SYM_INT || symbol == SYM_STRUCT) {
            ...
            if(symbol == SYM_INT)
                gr_variable(-address, (int*) 0, 0, add_counter);
            else if(symbol == SYM_STRUCT) {
                getSymbol();
                gr_struct(LOCAL_TABLE, -address, add_counter);
            }
            //print((int*) "gr_procedure: address= ");
            //print(itoa(address, string_buffer, 10, 0, 0));
            //print((int*) " AC= ");
            //print(itoa(*(add_counter), string_buffer, 10, 0, 0));
            //printLineNumber((int*)"ln:", lineNumber);
            //println();
            address = address + *(add_counter);
            if (symbol == SYM_SEMICOLON)
                getSymbol();
            else {
                syntaxErrorMessage((int*) "gr_procedure, ;error");
                println();
                syntaxErrorSymbol(SYM_SEMICOLON);
            }
        }
    ...
    *(add_counter) = 0;
    ...
    while (symbol != SYM_EOF) {
        ...
        //struct
            ...
            type = gr_struct(GLOBAL_TABLE, 0, add_counter);
            
            if (symbol == SYM_SEMICOLON)
                getSymbol();
            //else {
            //  syntaxErrorMessage((int*) "gr_cstar, ;error: ");
            //  printSymbol(symbol);
            //  println();
            //  syntaxErrorSymbol(SYM_SEMICOLON);
            // }
            ...
            if (symbol == SYM_IDENTIFIER) {
                ...
                if (symbol == SYM_LPARENTHESIS)
                    ...
                    if(symbol == SYM_INTEGER) {
                        index_1D = literal;
                        array_size = index_1D * WORDSIZE;
                        getSymbol();
                        if(symbol == SYM_RBRACKET) {
                            getSymbol();
                            if(symbol == SYM_SEMICOLON) {
                                getSymbol();
                                allocatedMemory = allocatedMemory + array_size;
                                createSymbolTableEntry(GLOBAL_TABLE, variableOrProcedureName, lineNumber, ARRAY, type, 0, -allocatedMemory, array_size, 0, (int*) 0);
                                ...
                                if(symbol == SYM_INTEGER) {
                                    if(literal > 0) {
                                        index_2D = literal;
                                        array_size = index_1D * index_2D * WORDSIZE;
                                        getSymbol();
                                        if(symbol == SYM_RBRACKET) {
                                            getSymbol();
                                            if(symbol == SYM_SEMICOLON) {
                                                getSymbol();
                                                allocatedMemory = allocatedMemory + array_size;
                                                createSymbolTableEntry(GLOBAL_TABLE, variableOrProcedureName, lineNumber, ARRAY, type, 0, -allocatedMemory, array_size, index_2D, (int*) 0);
                                            }
                                            else {
                                                syntaxErrorMessage((int*) " ; expected");
                                            }
                                ...
                                syntaxErrorMessage((int*) " ] or [ or ; expected");
                            }
                        }
                        else {
                            syntaxErrorMessage((int*) " ] expected");
                    ...
                    if (symbol == SYM_SEMICOLON) {
                        //print((int*)"gr_cstar createSymbolTableEntry");
                        //println();
                        createSymbolTableEntry(GLOBAL_TABLE, variableOrProcedureName, lineNumber, VARIABLE, type, 0, -allocatedMemory, 0, 0, (int*) 0);
                        ...
                        //print((int*)"gr_cstar initialization");
                        //println();
                        gr_initialization(variableOrProcedureName, -allocatedMemory, type, 0);
                    }
                }
            } else
                syntaxErrorSymbol(SYM_IDENTIFIER);
...
void emitMainEntry() {
    ...
    createSymbolTableEntry(GLOBAL_TABLE, (int*) "main", 0, PROCEDURE, INT_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitGlobalsStrings() {
    ...
    while ( entry != (struct SymbolTableEntry*) 0) {
        if (getClass(entry) == VARIABLE || getClass(entry) == STRUCT) {
            ...
            binaryLength = binaryLength + entry->size;
        }
...
void emitExit() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "exit", 0, PROCEDURE, VOID_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitRead() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "read", 0, PROCEDURE, INT_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitWrite() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "write", 0, PROCEDURE, INT_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitOpen() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "open", 0, PROCEDURE, INT_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitMalloc() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "malloc", 0, PROCEDURE, INTSTAR_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitID() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "hypster_ID", 0, PROCEDURE, INT_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitCreate() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "hypster_create", 0, PROCEDURE, INT_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitSwitch() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "hypster_switch", 0, PROCEDURE, INT_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitStatus() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "hypster_status", 0, PROCEDURE, INT_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitDelete() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "hypster_delete", 0, PROCEDURE, VOID_T, 0, binaryLength, 0, 0, (int*) 0);
...
void emitMap() {
    createSymbolTableEntry(LIBRARY_TABLE, (int*) "hypster_map", 0, PROCEDURE, VOID_T, 0, binaryLength, 0, 0, (int*) 0);
...
struct globalStruct* globalStructCopy  = (struct globalStruct*) 0;
...
void consTests(){
    ...
    println();
    print((int*)"g: ");
    print((int*)itoa(g, string_buffer, 10, 0, 0));
    println();
    print((int*)"h: ");
    print((int*)itoa(h, string_buffer, 10, 0, 0));
    println();
    print((int*)"i: ");
    print((int*)itoa(i, string_buffer, 10, 0, 0));
    println();
    print((int*)"j: ");
    print((int*)itoa(j, string_buffer, 10, 0, 0));
    println();
    print((int*)"k: ");
...
int main(int argc, int* argv) {
    ...
    //test2Darrays();
    testBoolean();
    myGlobal = (struct SymbolTableEntry*) malloc(24);
    myNext  = (struct SymbolTableEntry*) malloc(24);
    myGlobal->eins = 10;
    myGlobal->zwei = 20;
    myGlobal->drei = 30;
    myGlobal->vier = 40;
    myGlobal->five = (int*)"five";
    
    myNext->eins = 50;
    myNext->zwei = 60;
    myNext->drei = 70;
    myNext->vier = 80;
    myNext->five = (int*)"nextFive";
    myGlobal->next = myNext;
    ...
    globalStructCopy = myGlobal;
    i = globalStructCopy->eins;
    j = globalStructCopy->zwei;
    k = globalStructCopy->drei;
    l = globalStructCopy->vier;
    strii = globalStructCopy->five;
    
    print((int*)"MyGlobal eins:");
    print(itoa(myGlobal->eins, string_buffer, 10, 0, 0));
    print((int*)" zwei:");
    print(itoa(myGlobal->zwei, string_buffer, 10, 0, 0));
    print((int*)" drei:");
    print(itoa(myGlobal->drei, string_buffer, 10, 0, 0));
    print((int*)" vier:");
    print(itoa(myGlobal->vier, string_buffer, 10, 0, 0));
    print((int*)" 5:");
    printString(myGlobal->five);
    print((int*)" str:");
    printString(str);
    println();
    print((int*)"GlobalSymbolTable line:");
    print(itoa(global_symbol_table->line, string_buffer, 10, 0, 0));
    print((int*)" class:");
    print(itoa(global_symbol_table->class, string_buffer, 10, 0, 0));
    print((int*)" type:");
    print(itoa(global_symbol_table->type, string_buffer, 10, 0, 0));
    print((int*)" value:");
    print(itoa(global_symbol_table->value, string_buffer, 10, 0, 0));
    //print((int*)" name:");
    //strin = getString(global_symbol_table);
    //printString(strin);
    print((int*)" address:");
    print(itoa(global_symbol_table->address, string_buffer, 10, 0, 0));
    println();
    entry = global_symbol_table->next;
    print((int*)"GlobalSymbolTable line:");
    print(itoa(entry->line, string_buffer, 10, 0, 0));
    print((int*)" class:");
    print(itoa(entry->class, string_buffer, 10, 0, 0));
    print((int*)" type:");
    print(itoa(entry->type, string_buffer, 10, 0, 0));
    print((int*)" value:");
    print(itoa(entry->value, string_buffer, 10, 0, 0));
   // print((int*)" name:");
   // printString(entry->string);
    print((int*)" address:");
    print(itoa(entry->address, string_buffer, 10, 0, 0));
